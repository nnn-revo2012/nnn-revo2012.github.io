...
## 動画のダウンロードについて  
**ニコニコ生放送（ニコ生）は2025/02/05から新動画サーバー(dlive)の配信に移行しており2025/05には完全移行しています  
dliveで配信する動画はすべてAES128暗号化されており、これを解除する方法の公開やツール作成は日本の著作権法に違反する可能性があり、著作権者である株式会社ドワンゴ様から差し止め請求や訴えられる可能性があります。  
そのため現在の作者(nnn-revo2012)は本ツールを動画のダウンロード機能を削除しコメントのみのダウンロードツールとして公開していました。  
動画ダウンロードの方法はご自分で情報を探すなりして対応してください。**  
